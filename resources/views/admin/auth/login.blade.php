...
<head>
    ...
    <title>Login with ProductManagement Admin Dashboard </title>
                ...
                <ul class="nav navbar-nav flex-row">
                    ...
                    <li class="nav-item">
                        <a class="navbar-brand" href="index.html">
                            ...
                            <h3 class="brand-text">ProductManagement Admin Dashboard</h3>
                        </a>
                    </li>
                                        ...
                                        <form class="form-horizontal" action="{{  url('admin/login') }}" method="post"
                                           ...
                                           @csrf
                                            <fieldset class="form-group position-relative has-icon-left">
                                                <input type="email" class="form-control input-lg" id="user-name"
                                                  name="email"  placeholder="Your Username" required>
